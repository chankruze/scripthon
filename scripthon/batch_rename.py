...
if __name__ == "__main__":
    _directory = input("Enter the directory path: ")
    _naming_pattern = input("Enter the naming pattern (use {{}} as a placeholder for numbering): ")

    rename_files_in_directory(_directory, _naming_pattern)
